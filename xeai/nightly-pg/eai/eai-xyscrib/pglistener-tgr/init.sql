...
CREATE TRIGGER after_update_rms_aircraft_stand_parking_op AFTER UPDATE OF aircraft_visit_seq, aircraft_sp_seq, stand_code, on_block_time, off_block_time, est_on_block_time, est_off_block_time, movement_type, gate_code ON "public"."rms_aircraft_stand_parking_op" FOR EACH ROW EXECUTE PROCEDURE notify_after_update();
