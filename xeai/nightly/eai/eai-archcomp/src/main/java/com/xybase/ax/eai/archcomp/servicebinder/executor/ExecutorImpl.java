...
public class ExecutorImpl implements Executor {
	...
	private final static Logger log = LogManager.getLogger(ExecutorImpl.class);

	private AbstractApplicationContext baseContext;
	private String[] contextLocation;

	private MessageChannel channelIn;
	private PollableChannel channelOut;

	private MessageChannel controlIn;
	private PollableChannel controlOut;

	public ExecutorImpl(AbstractApplicationContext parent,
	...
	public ExecutorImpl(AbstractApplicationContext parent) {
		...
		channelOut = baseContext.getBean(ServiceBinderConstant.CHANNELOUT,
	...
	public void setContext(String... contextLocation) {
		...
		try {
			...
			log.error("Context ExecutorImpl ['" + (contextLocation)
