...
public class RepressorImpl implements Repressor<Message>, ExecutorBus,
		DisposableBean {

	private final static Logger log = LogManager.getLogger(RepressorImpl.class);
	...
	@Override
	public void repress(Message<Message> message) {
	...
	public void setBaseCtxResources(Larik baseContextResource) {
		...
		executor = new IExecutorImpl(baseCtx);
		this.onDeploy = false;
	}
